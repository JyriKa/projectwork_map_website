const places = {
    ...
    toripoliisi : {
        text : "A land mark statue in the market agora of Oulu. A robust policeman, with a vigilant unwavering gaze. It is another popular gathering place inside the city centre for some activities.",
        longitude : 65.01329,
        latitude : 25.46471,
        address : "Kauppatori 2, 90100 Oulu"
    },
    matkahuolto : {
        text : "Matkahuolto is basically the bus station that connects you to rest of Finland. Native students who face financial hardship are wise to have enough savings left to buy themselves a bus ticket that takes them back to their caring parents, where the fridge is stocked with goods, and the stove prepares meals other than macaroni.",
    ...
    trainStation : {
        text : "If taking a bus is not a feasible option, the train station right next to Matkahuolto can speed you away to locations further away from Oulu. There is a pedestrian tunnel going under the railroad tracks, connecting Matkahuolto with the eastern city centre.",
    ...
    bikeStuff : {
        text : "There are various bike stores spread around in Oulu. A bicycle is often the main means of transportation for a student. Not only is it a healthy form of everyday exercise, but it can also save you money over taking a bus, and time if the option were to walk. In recent years, there was a push for rentable city bikes, too, but it is still figuring itself out.",
        longitude : 65.02561,
        latitude : 25.47724,
        address : "Valtatie 49, 90500 Oulu",
        businesshours : "Jussin Pyöräpiste\nMonday-Friday: 9am-6pm\nSaturday: 9am-2pm"
    },
    yths : {
        text : "The student healthcare is located right next to the university, providing vital services such as dentistry, general practice, and mental health services. If you are a student, you have the student healthcare fee as well, so you are viable to use their services. For more serious and acute ailments, the actual hospital is probably a better choice, despite being a good distance away from the campus region.",
